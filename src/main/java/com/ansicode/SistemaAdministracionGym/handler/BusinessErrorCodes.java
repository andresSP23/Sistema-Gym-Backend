...
public enum BusinessErrorCodes {
        ...
        USER_BIRTHDATE_INVALID(2105, HttpStatus.BAD_REQUEST,
        ...
        CLIENTE_FECHA_NACIMIENTO_INVALIDA(2204, HttpStatus.BAD_REQUEST,
                        "La fecha de nacimiento no puede ser hoy ni una fecha futura"),
        CLIENTE_UNDERAGE(2205, HttpStatus.BAD_REQUEST, "El cliente debe ser mayor de 18 años"),
        CLIENTE_DELETE_NOT_ALLOWED(2206, HttpStatus.CONFLICT,
                        "No se puede eliminar el cliente porque tiene registros asociados"),
        CLIENTE_CODIGO_INTERNO_ERROR(2207, HttpStatus.INTERNAL_SERVER_ERROR,
                        "No se pudo generar el código interno del cliente"),
        CLIENTE_ALREADY_EXISTS(2208, HttpStatus.CONFLICT, "El cliente ya existe"),
        ...
        ASISTENCIA_SUSCRIPCION_NO_ACTIVA(2302, HttpStatus.BAD_REQUEST,
                        "El cliente no tiene una suscripción activa o está vencida"),
        ...
        CATEGORIA_PRODUCTO_DELETE_NOT_ALLOWED(2402, HttpStatus.CONFLICT,
        ...
        SUSCRIPCION_DURACION_INVALIDA(2504, HttpStatus.BAD_REQUEST,
                        "Servicio de suscripción debe tener duracionDias válida"),
        SUSCRIPCION_NOT_FOUND(2505, HttpStatus.NOT_FOUND, "Suscripción no encontrada"),
        SUSCRIPCION_YA_CANCELADA(2506, HttpStatus.CONFLICT, "La suscripción ya está cancelada"),
        ...
        COMPROBANTE_VENTA_SIN_DETALLES(2602, HttpStatus.BAD_REQUEST,
                        "No se puede generar comprobante: la venta no tiene detalles"),
        ...
        COMPROBANTE_PDF_NOT_FOUND_OR_UNREADABLE(2605, HttpStatus.NOT_FOUND,
                        "El archivo PDF no existe o no se puede leer"),
        ...
        MOVIMIENTO_DINERO_RANGO_FECHAS_INVALIDO(3008, HttpStatus.BAD_REQUEST,
        ...
        PAGO_CLIENTE_NO_COINCIDE_CON_VENTA(3210, HttpStatus.BAD_REQUEST,
        ...
        PAGO_SUCURSAL_REQUIRED(3218, HttpStatus.BAD_REQUEST,
                        "La venta debe tener sucursal para registrar el movimiento de dinero"),

        PAGO_DETALLE_PRODUCTO_SIN_CANTIDAD(3219, HttpStatus.BAD_REQUEST, "Detalle de producto sin cantidad"),
        PAGO_DETALLE_PRODUCTO_CANTIDAD_NO_ENTERA(3220, HttpStatus.BAD_REQUEST,
        ...
        PRODUCTO_SUCURSAL_REQUIRED_PARA_EGRESO(3408, HttpStatus.BAD_REQUEST,
                        "sucursalId es obligatorio cuando registrarEgreso = true"),
        PRODUCTO_METODO_PAGO_REQUIRED_PARA_EGRESO(3409, HttpStatus.BAD_REQUEST,
                        "metodoPago es requerido cuando registrarEgreso = true"),
        ...
        SERVICIO_DURACION_REQUIRED_PARA_SUSCRIPCION(3503, HttpStatus.BAD_REQUEST,
                        "Para suscripción duracionDias debe ser válida"),

        SERVICIO_FILTRO_SUSCRIPCION_REQUIRED(3504, HttpStatus.BAD_REQUEST,
                        "El filtro suscripcion es obligatorio (true/false)"),
        ...
        SESION_CAJA_YA_ABIERTA_SUCURSAL(3606, HttpStatus.CONFLICT,
                        "Ya existe una sesión de caja ABIERTA para esta sucursal"),
        SESION_CAJA_NO_ABIERTA_SUCURSAL(3607, HttpStatus.BAD_REQUEST,
        ...
        SUCURSAL_HORARIO_INVALIDO(3704, HttpStatus.BAD_REQUEST,
        ...
        VENTA_CLIENTE_REQUIRED_PARA_SERVICIO(3802, HttpStatus.BAD_REQUEST,
                        "clienteId es obligatorio para ventas de servicio"),
